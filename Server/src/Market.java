 ...
 * containing the hashmaps for all assets, trades and organisations with the database
 * @throws SQLException SQL was unable to be passed due to SQL error or was unable to connect to the DB
 * @throws ClassNotFoundException unable to prase the class into the requred type
 * @throws IOException Unable to form a connection between the server and client
 */
